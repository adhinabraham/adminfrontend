                    ...
                    <div className="flex items-center justify-between border-b border-gray-200 dark:border-gray-700 py-4">
                        <div>
                            <div className="hidden lg:block cursor-pointer" role="img" aria-label="luxe. Logo.">
                                <svg className="fill-stroke dark:text-white text-gray-900" width={55} height={25} viewBox="0 0 55 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                            ...
                            <div className="hidden md:block lg:hidden cursor-pointer" role="img" aria-label="luxe. Logo.">
                                <svg className="fill-stroke dark:text-white text-gray-800" width={44} height={20} viewBox="0 0 44 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                            ...
                            <div className="md:hidden cursor-pointer" role="img" aria-label="luxe. Logo.">
                                <svg className="fill-stroke dark:text-white text-gray-800" width={37} height={17} viewBox="0 0 37 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                        ...
                        <div className="hidden md:block">
                            <ul className="flex items-center space-x-6">
                                ...
                                <li>
                                    <button  className="dark:text-white dark:hover:text-gray-300 text-base text-right text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline" onClick={logout}>
                                        {" "}
                                     logout{" "}
                                    </button>
                                </li>
                        ...
                        {/* <div className="hidden md:flex items-center space-x-4">
                            ...
                            <a aria-label="Bag" href="javascript:void(0)" className="focus:outline-none focus:ring-2 focus:ring-gray-800 hover:bg-gray-100 p-0.5 rounded">
